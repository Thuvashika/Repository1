...
<head>
<title>LEADS</title>
<link href="<s:url value ="/css/view.css"/>" rel="stylesheet">
<script type="text/javascript" src="js/leadsView.js"></script>
...
<body>
	...
	<hr style="width:50%;margin-right: auto;  margin-left: auto; size:8; width=90%">
	<br>
	<div>
	...
	<button class="button" onclick="window.location.href ='/Struts2Project/AllLeadsView.jsp'" >All leads</button>
	<div id="pagin" class="center">
	<label for="no"><b>Leads per page</b></label>
   	<input style="text-align:center" type="text" pattern="[0-9]{2}" value=5 onkeyup="records()" name="no" id="no" required>
   	</div>
	<br>
	<br>
